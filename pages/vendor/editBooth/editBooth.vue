<template>
	<view class="content">
		...
		<view class="btTab">
			<image class="boothImg" :src="boothPic" @click="chooseImage"></image>
		</view>
		...
		<view class="list">
			...
			<view class="row">
				...
				<input class="title right" type="text" v-model="boothInfo.boothName" />
			</view>
			...
			<view class="row">
				...
				<picker mode="time" @change="bindStartTimeChange" start="5:00" end="24:00" :value="boothInfo.startTime">
					<view class="right">{{formatTime(boothInfo.startTime)}}<uni-icons type="right"></uni-icons></view>
				</picker>
			</view>
			<view class="row">
				<view class="title left">营业结束时间：</view>
				<picker mode="time" @change="bindEndTimeChange" start="5:00" end="24:00" :value="boothInfo.endTime">
					<view class="right">{{formatTime(boothInfo.endTime)}}<uni-icons type="right"></uni-icons></view>
				</picker>
			</view>
